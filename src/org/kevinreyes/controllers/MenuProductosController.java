...
import org.kevinreyes.report.GenerarReporteProductos;
...
public class MenuProductosController implements Initializable {
    ...
    @FXML
    Button btnRegresar,btnAgregar,btnEditar,btnEliminar,btnBuscar, btnVerProducto;
    ...
    public void handleButtonAction(ActionEvent event){
        ...
        if(event.getSource() == btnRegresar){
            ...
            GenerarReporteProductos.getInstance().generarProducto(((Productos)tblProductos.getSelectionModel().getSelectedItem()).getProductoId());
        }
    ...
    public void cargarDatos(){
        if(op == 3){
            ...
            colCategoriaPId.setCellValueFactory(new PropertyValueFactory<Productos, String>("CategoriaProducto"));
